export const API_BASE_URL = 'https://mabdullah249.pythonanywhere.com/';
...
export const GET_ALL_SUBJECTS_WITH_COURSES = API_BASE_URL + 'subjectwithcourses/';
...
export const GET_SUB_SUBJECTS_BY_SUBJECT = API_BASE_URL + 'getactivecoursesbysubject/';
